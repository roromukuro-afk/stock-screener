...
from app.routers import dashboard, screening, stocks, exclusions, export, backtest, settings as settings_router, universe as universe_router, aar as aar_router, prediction as prediction_router, research_forecast as research_forecast_router, training_builder as training_builder_router, automation as automation_router, surge_20 as surge_20_router
...
app.include_router(research_forecast_router.router)
app.include_router(training_builder_router.router)
app.include_router(automation_router.router)
app.include_router(surge_20_router.router)
